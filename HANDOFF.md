...
**Status:** Steps 0, 0b, 1A, 2 complete (2026-09-03); 1B built and measured on desktop — the browser measurement waits on the non-Mono Godot download. Step 3 (UI) next. TeeJ's standing order: proceed independently and commit until the port is complete.
