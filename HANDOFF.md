...
**Status:** Steps 0, 0b, 1A, 2, 3 complete (2026-09-03); 1B built and measured on desktop — the browser measurement and step 4 wait on the non-Mono Godot download. Step 3's UI is untested by a human: TeeJ has not yet played the GDScript build. TeeJ's standing order: proceed independently and commit until the port is complete.
